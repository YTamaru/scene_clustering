...
def video_2_frames(VIDEOS_DIR, TARGET_IMAGES_DIR):
    ...
    for file in files:
        ...
        cube_frame = py360convert.e2c(e_frame, face_w=256, mode="bilinear", cube_format="dice")
        cube_img = Image.fromarray(cube_frame)
        cube_img.save(TARGET_IMAGES_DIR+'/'+os.path.basename(file))
