...
def resize_frames(VIDEOS_DIR, TARGET_IMAGES_DIR):
    ...
    for file in files:
        ...
        if not os.path.exists(TARGET_IMAGES_DIR):
            os.makedirs(TARGET_IMAGES_DIR)	# Make a directory
        img.save(TARGET_IMAGES_DIR+'/'+os.path.basename(file))
        print('Save', TARGET_IMAGES_DIR+'/'+os.path.basename(file))
    ...
    if os.path.isdir(VIDEOS_DIR):
        ...
        for file in files:
            if os.path.isdir(VIDEOS_DIR +'/'+file):
                ...
                resize_frames(VIDEOS_DIR, TARGET_IMAGES_DIR)
                break
...
if __name__ == "__main__":
    data_dir_path = '/home/tamaru/scene_categorize/main/data/insta_frames'
    save_dir_path = '/home/tamaru/scene_categorize/main/data/insta_resized'
